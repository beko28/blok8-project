...
<div class="container mx-auto mt-10 px-4">
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Nieuwe Poule</h1>
    ...
    <form action="{{ route('poules.store') }}" method="POST" class="bg-white p-6 shadow-md rounded">
        @csrf
        <div class="mb-4">
            <label for="naam" class="block text-gray-700 font-bold mb-2">Naam:</label>
            <input type="text" name="naam" id="naam" class="w-full p-2 border rounded" value="{{ old('naam') }}">
        </div>
