...
<div class="container mx-auto p-8">
    ...
    <!-- Formulier -->
    <form action="{{ route('spelers.store') }}" method="POST" class="bg-white shadow-md rounded p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="positie" id="positie" class="border rounded w-full p-2" value="{{ old('positie') }}" required>
        </div>
        <div class="mb-4">
            <label for="leeftijd" class="block font-semibold mb-2">Leeftijd</label>
            <input type="number" name="leeftijd" id="leeftijd" class="border rounded w-full p-2" value="{{ old('leeftijd') }}" required>
        </div>
